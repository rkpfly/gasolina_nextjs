                    ...
                    <div className="lg:col-span-5 fade-up">
                        <div className="lg:sticky lg:top-32">
                            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-extrabold tracking-tighter uppercase leading-[0.9] text-brand-black mb-3 sm:mb-4 md:mb-6">
                                ...
                                <span className="text-brand-gray text-transparent [-webkit-text-stroke:1px_#0A0A0A] hover:text-brand-black hover:[-webkit-text-stroke:0px] transition-all duration-400 cursor-default">
                                    {contactTitle.last}
                                </span>
                            </h2>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mb-10 sm:mb-12 md:mb-16 fade-up">
                        <div className="flex md:block max-w-2xl">
                            <h2 className="flex flex-col items-end text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-display font-bold tracking-tighter uppercase text-brand-black leading-[0.9]">
                                ...
                                <span className="text-transparent [-webkit-text-stroke:1px_#0A0A0A]">{faqTitle.last}</span>
                            </h2>
                        </div>
                                ...
                                <>
                                    <div className="mb-6 flex justify-between items-start gap-3">
                                        <div className="flex items-start gap-2 flex-1">
                                            <h4 className="text-base md:text-lg font-display font-bold uppercase tracking-tighter text-brand-black transition-colors duration-300 w-full group-hover:text-white">
                                                {faq.question}
                                            </h4>
                                            {faq.pageLink && (
                                                <span className="text-brand-black transition-colors duration-300 group-hover:text-brand-accent flex-shrink-0 mt-0.5">
                                                    📄
                                                </span>
                                            )}
                                        </div>
                                        <i className={`${faq.icon} text-brand-gray text-xl transition-colors duration-300 group-hover:text-brand-accent flex-shrink-0`}></i>
                                    </div>
