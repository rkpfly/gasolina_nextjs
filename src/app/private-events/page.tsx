        ...
        <div className="max-w-[1600px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/10 border border-white/10">
            {OCCASIONS.map((o, i) => (
              ...
              >
                <span className="block text-3xl md:text-4xl font-display font-bold text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.3)] group-hover:[-webkit-text-stroke:1px_#FF2323] transition-all duration-300 mb-6">
                  {o.num}
                </span>
