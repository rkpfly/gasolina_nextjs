...
export default function CorporateClient() {
    ...
    return (
        <main className="w-full bg-brand-black text-brand-white selection:bg-brand-blue selection:text-brand-white">
            ...
            {/* ── HERO SECTION ── */}
            <section className="relative h-[88svh] md:h-[100svh] min-h-[400px] sm:min-h-[450px] w-full md:px-6 lg:px-12 pt-16 sm:pt-24 md:pt-20 pb-6 sm:pb-8 md:pb-12 flex flex-col">
                <div
                ...
                >
                    <MediaSlot
                        id="hero-media"
                        mediaMap={media}
                        className={`absolute inset-0 w-full h-full object-cover filter grayscale opacity-60 transition-transform duration-[8000ms] ease-out ${
            ...
            {/* ── TEXT INTRO SECTION ── */}
            <section className="py-12 sm:py-16 md:py-20 px-3 sm:px-4 md:px-6 lg:px-12 bg-brand-black text-center">
                <div className="max-w-4xl mx-auto fade-up">
                    <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-display font-bold tracking-tighter uppercase text-brand-white mb-4 sm:mb-6 leading-[0.95]">
                        Redefine Your <br />
            ...
            <section className="py-12 sm:py-16 md:py-24 px-3 sm:px-4 md:px-6 lg:px-12 bg-[#0f0f10]">
                <div className="max-w-[1600px] mx-auto">
                    <div className="flex justify-center mb-8 sm:mb-12 md:mb-16 fade-up">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold tracking-tighter uppercase text-brand-white text-center">
                            Our Capabilities
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                        {capabilities.map((cap) => (
                            <div
                                key={cap.id}
                                className="bg-white/5 p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 hover:border-white/30 hover:bg-white/[0.07] transition-all duration-300 fade-up group flex flex-col"
                                style={{ transitionDelay: cap.delay }}
                            >
                                <div className="w-full h-32 sm:h-40 mb-4 sm:mb-6 overflow-hidden rounded-lg sm:rounded-xl bg-white/5">
                                    <MediaSlot
                                        id={cap.id}
                                        mediaMap={media}
                                ...
                                <h3 className="text-lg sm:text-xl font-display font-bold uppercase tracking-tighter text-brand-white mb-2 sm:mb-3">
                                    {cap.title}
                                </h3>
            ...
            <section className="py-10 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6 lg:px-12 bg-brand-black border-t border-white/10">
                <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 items-stretch">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center py-6 sm:py-8 mt-6 sm:mt-8 lg:mt-0 fade-up" style={{ transitionDelay: '200ms' }}>
                        <div className="max-w-xl w-full mx-auto lg:mx-0">
                            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold uppercase tracking-tighter text-brand-white mb-2">Plan Your Event</h3>
